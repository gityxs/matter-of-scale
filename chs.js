...
var cnItems = {
    ...
    "Assign": "分配",
    "Bloodhound": "猎犬",
    "Broughton Crossing": "布劳顿十字路口",
    "Build 100 Pathfinders": "建造100个探路者",
    "Build 100 Rivers": "修建100条河流",
    "Build 100 Scouts": "建造100个侦察兵",
    "Build 100 Trappers": "建造100个陷阱",
    "Build 100 Wellsprings": "建造100个水井",
    "Building": "建筑",
    "Click 5 Research events for Hamlets": "点击5个村庄的研究活动",
    "Click 5 Upgrade events for Hamlets": "单击5升级村庄事件",
    "Click 50 Vote events": "点击50个投票事件",
    "Count": "计数",
    "Donate BTC": "捐赠BTC",
    "Donate CC": "捐赠CC",
    "Donate Patreon": "捐赠Patreon",
    "Doubles Archer income": "弓箭手收入翻倍",
    "Doubles Bloodhound income": "猎犬的收入翻倍",
    "Doubles Spearman income": "枪兵收入翻倍",
    "Doubles Tracker income": "追踪者收入翻倍",
    "Feats": "功绩",
    "Follow on Reddit": "关注Reddit",
    "Follow on Twitter": "关注Twitter",
    "hamlet": "村庄",
    "Hamlet gain 5": "村庄增益5",
    "Have a Hamlet with at least 50 income": "拥有一个收入至少50的村庄",
    "Income": "收入",
    "Managers": "管理者",
    "New Slot": "新槽位",
    "Offline Time": "离线时间",
    ...
    "Wellspring": "水井",
    "Woodsman": "樵夫",
    "Doubles Pathfinder income": "探路者收入加倍",
    "Export game to string": "将游戏存档导出为字符串",
    "Have a Hamlet with at least 500 income": "拥有一个收入至少500英镑的村庄",
    ...
    "Auto-completes Hamlets after 120 (from never) seconds": "120秒后(从无开始)自动完成村庄",
    "Autobuy": "自动购买",
    "Butlers Cross": "巴特勒十字路口",
    "Complete": "完成",
    "Doubles River income": "河流收入翻倍",
    "Doubles Scout income": "侦察兵收入翻倍",
    "Doubles Trapper income": "捕兽者收入翻倍",
    "Doubles Wellspring income": "水井收入翻倍",
    "Doubles Woodsman income": "樵夫收入翻倍",
    "Kim Jones": "金·琼斯",
    "Unassigned": "未分配",
    "Bradville": "布拉德维尔",
    "Donna Boyd": "唐娜·博伊德",
    "Durgan": "杜尔根",
    "Kim Haverford": "金·哈弗福德",
    "": "",
    "": "",
    "": "",
    "": "",
...
var cnPrefix = {
    ...
    "Notation: ": "符号: ",
    "Toggle Music: ": "切换声音: ",
    "Hamlet (Next in ": "部落 (下一个在 ",
    "Village (Next in ": "村庄 (下一个在 ",
...
var cnRegReplace = new Map([
    ...
    [/^Hamlets spawn with (.+) \(from (.+)\)$/, '村庄生成 $1 \(从 $2 开始\)'],
    [/^Hamlets generate upgrade points (.+) \(from (.+)\) faster$/, '村庄生成升级点的速度从 $2 提高 $1'],
    [/^Hamlet ignore (.+) \(from (.+)\) buildings for cost$/, '村庄忽略 $1 \(从 $2\)建筑成本'],
    [/^Hamlet buildings cost (.+) \(from (.+)\) less$/, '村庄建筑的成本减少 $1 \(原为 $2\)'],
    [/^Autobuy Bloodhound cost (.+) \(from (.+)\)$/, '自动购买猎犬的成本 $1 \(原为 $2\)'],
    [/^\/ sec \(from (.+)\)$/, '\/ 秒 \(从 $1\)'],
